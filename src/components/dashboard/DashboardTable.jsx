...
export default function DashboardTable() {
  ...
  //   const isRefreshedScreen = useSelector(
  //     (state) => state.DataPMOReducer.isRefreshedScreen
  //   );

  //   const masterDataList = useSelector(
  //     (state) => state.DataPMOReducer.masterDataList
  //   );
          ...
          <TableContainer>
            <Table size="medium">
              ...
              <TableBody>
                ...
                {records.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={9}>No Record Found(s)</TableCell>
                  </TableRow>
                ) : null}
